    ...
    <div className={style.login_image}>
      ...
      <form className={style.glass}>
        <div className="h-[20%] w-full flex flex-col gap-2 items-center justify-center text-[cyan]">
          <h4 className={"text-4xl " + poppins.className}>Signup</h4>
          <p className="text-[#00ffffab]">Signup to continue shopping</p>
        </div>
        <div className="w-full h-[60%] flex flex-col items-center gap-3 mt-4">
          ...
          <input type="password" placeholder="Confirm password" className="bg-transparent border-solid border-b-2 text-[#a2acba] outline-0 p-2 px-4" required />
          <Button
            text="Signup"
            type="submit"
            className="p-2 px-4 bg-[#0d0827cc] mt-3 rounded-xl text-lg text-[#ffffffde] hover:text-cyan-400 hover:bg-[#060507cc] font-medium"
          />
          <p className="text-white">Already have an account? <Link href="/login" className="text-blue-800 hover:decoration-blue-800 hover:underline font-semibold">Login</Link></p>
