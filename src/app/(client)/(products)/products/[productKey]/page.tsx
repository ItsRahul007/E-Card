...
const AllProduct: FC<I_AllProduct> = async ({ searchParams }) => {
  ...
  return (
    <div className="h-screen w-screen bg-rootBg flex flex-col">
      <Navbar filters={true} />
