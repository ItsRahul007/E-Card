  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-rootBg rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full p-4 pt-12 relative">
          <IconButton
            icon={<i className="ri-close-fill"></i>}
            onClick={closeModel}
            type="button"
            className="absolute top-1 right-1 cursor-pointer text-2xl px-1 py-[2px] rounded hover:bg-lightBg"
          />
