...
const ProductSkeletonLoading = () => {
    return (
        <div className='border sm:h-72 min-[390px]:h-60 h-52 sm:w-52 min-[390px]:w-44 w-36 flex flex-col items-center gap-1 overflow-hidden rounded-md shadow bg-white hover:translate-y-[-2px] col-span-1'>
