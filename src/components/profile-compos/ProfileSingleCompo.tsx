  ...
  return (
    <div className="h-auto w-full flex flex-col gap-3">
      <div className="w-fit flex justify-between gap-6 items-end">
        <h3 className="text-sm text-zinc-400 font-medium capitalize">
          {headingText}
        </h3>
        <span
          className="text-appTheme-700 cursor-pointer text-base font-medium select-none"
