...
const Products: React.FC<I_Products> = ({
  ...
  const {
    ...
    query: searchKey
      ? ["products", price ? price : "", searchKey]
  ...
  return (
    <div className="bg-lightBg flex-1">
      <div className="h-full w-full overflow-scroll flex items-start justify-center">
        <div className="grid grid-rows-none gap-4 justify-center relative grid-cols-2 sm:grid-cols-3 md:p-4 p-2 lg:grid-cols-4 xl:w-[72rem] lg:w-full xl:grid-cols-5">
          {
            //? loading components
            isLoading &&
          ...
          <div
            className={`xl:col-span-5 lg:col-span-5 sm:col-span-3 col-span-2
