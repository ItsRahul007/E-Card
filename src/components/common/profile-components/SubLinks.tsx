        ...
        {subLinks.map((obj) => (
          <Link
            ...
            className={classNames(
              ...
              isSlider
                ? "hover:text-appTheme-500 bg-opacity-5 hover:bg-appTheme-50 hover:bg-opacity-5 dark:hover:bg-zinc-800"
                : "hover:bg-appTheme-50 hover:text-appTheme-700 dark:hover:bg-zinc-800",
              currentTab === obj.link
                ? "bg-appTheme-50 !text-appTheme-600 dark:bg-zinc-800"
                : ""
            )}
          >
