...
import LoopItems from '../all-products/LoopItems';
...
const RelatedProducts: FC<I_RelatedProducts> = async ({ product_type, product_category, productId }) => {
                    ...
                    <div className='h-auto w-full xl:w-11/12 flex flex-col p-2 gap-4'>
                        ...
                        <div className='flex flex-col h-full xl:w-[72rem] lg:w-full self-center'>
                            ...
                            >
                                {
                                    relatedProducts.map((item) => {
                                        if (JSON.stringify(item._id) === JSON.stringify(productId)) return <></>;
                                        return (
                                            <ItemCard
                            ...
                            { relatedProducts.length > 5 &&
                                <Link href={ "/products/search-products?search=" + product_type + " for " + product_category }
